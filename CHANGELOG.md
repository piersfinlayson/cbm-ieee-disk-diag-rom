...
- Detect DOS1 and DOS2 drives 2040/3040/4040s, and 8050/8250s.
- Expose drive type via an IEEE-488 status command.
- Correctly take over secondary processor on all drive types.
- Use short-link for repository to reduce image size.
